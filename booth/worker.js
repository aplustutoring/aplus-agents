      ...
      html: `
        <div style="font-family:Arial,Helvetica,sans-serif;max-width:560px;margin:0 auto;background:#F7F4EC;padding:32px;border-radius:16px;">
          ...
          <p style="margin:28px 0;">
            <a href="https://aplustutoring.com" style="background:#E2A33B;color:#1E281C;font-weight:bold;text-decoration:none;padding:14px 28px;border-radius:999px;display:inline-block;">Learn how it works</a>
          </p>
