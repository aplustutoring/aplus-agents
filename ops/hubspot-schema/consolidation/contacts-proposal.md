...
|---|---|---|---|---|---|---|---|
| `actively_counseling` | Actively Counseling | customer_group | 52 | 2021-07-06 | BLOCKED — referenced by: wf4:Pipeline is "College Access Plus", deal stage is "Decision D; wf4:Pipeline is "College Access Plus", deal stage is "Did Not Us; wf4:Pipeline is "College Access Plus", deal stage is "Payment Re | Legacy ops flag (2021-23 era) |  |
| `actively_tutoring` | Actively Tutoring | customer_group | 3318 | 2021-07-06 | BLOCKED — referenced by: list:Actively Tutoring - Yes; list:Ask for Reviews; list:Resume after Stopped for Summer; wf4:Pipeline is "CFGC", deal stage is "Package Used Up"… | Legacy ops flag (2021-23 era) |  |
| `additional_note` | Additional note | contactinformation | 1 | 2023-11-25 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Legacy one-off field (see fill count / Used-in) |  |
| `ap_subjects` | Which AP Subjects are you interested in? | unused_properties | 1 | 2022-01-14 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `are_missing_assignments_a_concern` | Are missing assignments a concern? | lead_ads | 0 | 2020-07-07 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | FB lead-ad capture leftovers |  |
| `asked_for_a_review_` | Asked for a review? | customer_group | 115 | 2021-07-06 | BLOCKED — referenced by: list:Ask for Reviews | Legacy ops flag (2021-23 era) |  |
| `assessment_attended___in_house` | Assessment Attended - In House | customer_group | 7 | 2021-12-22 | BLOCKED — referenced by: wf3:Diagnostic Testing - In House; wf4:Diagnostic Testing - In House | Legacy ops flag (2021-23 era) |  |
| `assessment_graded___in_house` | Assessment Graded - In House | customer_group | 7 | 2021-12-22 | BLOCKED — referenced by: wf3:Diagnostic Testing - In House; wf4:Diagnostic Testing - In House | Legacy ops flag (2021-23 era) |  |
| `assessment_received` | Assessment Graded - Remote | customer_group | 77 | 2021-12-22 | BLOCKED — referenced by: wf3:Diagnostic Testing - Remote; wf3:Qualified Tutoring Lead Workflow - Diagnostic Sent; wf4:Diagnostic Testing - Remote; wf4:Qualified Tutoring Lead Workflow - Diagnostic Sent | Legacy ops flag (2021-23 era) |  |
| `assessment_sent` | Assessment Sent | customer_group | 349 | 2021-09-10 | BLOCKED — referenced by: wf3:Qualified Tutoring Lead Workflow - Diagnostic Sent; wf4:Qualified Tutoring Lead Workflow - Diagnostic Sent | Legacy ops flag (2021-23 era) |  |
...
| `current_employer` | Current Employer | new_tutors | 35 | 2022-03-07 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Tutor-recruiting leftover not in the tutor keeper set |  |
| `date_for_first_free_lessons` | Date For First Free Lessons | date_properties | 0 | 2021-06-01 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Summer-2021 scheduling flow leftovers |  |
| `date_of_first_session` | When does the school year start for your child? | date_properties | 2 | 2021-05-24 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Summer-2021 scheduling flow leftovers |  |
| `date_of_tutoring_session_for_trial` | Date of Tutoring Session for Trial | contactinformation | 0 | 2023-11-25 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Legacy one-off field (see fill count / Used-in) |  |
| `date_to_start_customer_provided` | Date To Start New Schedule - Summer Update | date_properties | 8 | 2021-05-26 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Summer-2021 scheduling flow leftovers |  |
| `date_to_stop_lessons_for_summer_update___schedule_update` | Date To Stop Lessons for Summer Update - Schedule Update | date_properties | 3 | 2021-05-26 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Summer-2021 scheduling flow leftovers |  |
| `day_preference` | Day Preference | contactinformation | 0 | 2023-11-02 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Legacy one-off field (see fill count / Used-in) |  |
| `decision_day` | Decision Day | customer_group | 36 | 2022-01-14 | BLOCKED — referenced by: wf4:Pipeline is "College Access Plus", deal stage is "Decision D | Legacy ops flag (2021-23 era) |  |
| `do_you_have_a_college_list_created_` | Do you have a college list created? | unused_properties | 1 | 2022-01-14 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `do_you_want_to_update_your_tutoring_schedule_` | Do you want to update your tutoring schedule? | customer_group | 9 | 2021-05-24 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Legacy ops flag (2021-23 era) |  |
| `do_you_want_your_student_to_receive_email_notifications_for_lesson_reminders_` | Do you want your student to receive email notifications for lesson reminders? | customer_group | 21 | 2023-12-28 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Legacy ops flag (2021-23 era) |  |
| `elementary_school_subject` | Elementary School Subjects | unused_properties | 34 | 2022-01-14 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `end_date_for_tutoring_for_this_deal___deal_specific` | End Date for Tutoring for this Deal - Deal Specific | date_properties | 0 | 2021-05-26 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Summer-2021 scheduling flow leftovers |  |
| `engaged_with_teacher_` | Engaged with Teacher? | contactinformation | 1 | 2025-05-22 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Legacy one-off field (see fill count / Used-in) |  |
| `english_subjects` | English Subjects | unused_properties | 2 | 2023-08-17 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `full_name` | Full Name | contactinformation | 10189 | 2025-10-01 | BLOCKED — referenced by: wf3:Full Name; wf3:Lead Pipe Line - Online; wf4:Full Name; wf4:Lead Pipe Line - Online | Duplicate of firstname+lastname; updatedAt 2025-10 so check Used-in carefully |  |
| `get_started_form_start_date` | Get Started Form Only - Start Date | date_properties | 348 | 2021-05-24 | BLOCKED — referenced by: wf3:Copy Properties for Monday; wf3:Get Started Now - FORM SUBMISSION to Deal Create GOLD; wf4:Copy Properties for Monday; wf4:Get Started Now - FORM SUBMISSION to Deal Create GOLD | Summer-2021 scheduling flow leftovers |  |
| `has_bonus_been_paid_out_` | Has Bonus Been Paid Out? | customer_group | 8 | 2022-04-19 | BLOCKED — referenced by: list:Bonus Paid | Legacy ops flag (2021-23 era) |  |
| `has_your_child_worked_with_a_tutor_before_` | Has your child worked with a tutor before? | unused_properties | 39 | 2022-01-14 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `have_missing_assignments_been_an_issue_` | Have missing assignments been an issue? | unused_properties | 34 | 2022-01-14 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `have_you_taken_the_sat_or_act_already_` | Have you taken the SAT or ACT before? | unused_properties | 12 | 2022-01-14 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `high_school_subjects` | High School Subjects | unused_properties | 13 | 2022-01-14 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `how_did_you_hear_about_this_opportunity_with_a_tutoring` | How did you hear about this opportunity with A+ Tutoring | new_tutors | 1141 | 2022-10-27 | BLOCKED — referenced by: wf3:REFERRAL PROGRAM - NEW TEACHERS; wf4:REFERRAL PROGRAM - NEW TEACHERS | Tutor-recruiting leftover not in the tutor keeper set |  |
| `how_did_you_hear_about_us___cloned__original_` | How Did You Hear About Us? (Cloned)(original) | contactinformation | 6763 | 2022-11-08 | BLOCKED — referenced by: list:Royal; list:Yelp; wf3:How Did You Hear About Us Copied; wf4:How Did You Hear About Us Copied | Legacy one-off field (see fill count / Used-in) |  |
| `how_many_students_will_be_in_your_small_learning_pod_` | How many students will be in your small learning pod? | unused_properties | 37 | 2022-01-14 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
...
| `major` | Major | new_tutors | 35 | 2022-03-07 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Tutor-recruiting leftover not in the tutor keeper set |  |
| `marketing_newsletter` | Marketing Newsletter | customer_group | 0 | 2023-08-17 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Legacy ops flag (2021-23 era) |  |
| `middle_school_subjects` | Middle School Subjects | unused_properties | 10 | 2022-01-14 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `ms_and_hs_entrance_exams` | MS and HS Entrance Exams | unused_properties | 4 | 2022-01-14 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `name_of_primary_contact_for_your_pod` | Name of Primary Contact for your pod | contactinformation | 23 | 2020-08-05 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Legacy one-off field (see fill count / Used-in) |  |
| `nps` | NPS | customer_group | 0 | 2021-05-24 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Contact NPS number — scorecard NPS now sourced from Monday boards; verify Used-in (lists/reports) before archive |  |
| `optional__please_attach_a_pdf_of_the_student_s_most_up_to_date_iep_or_504_plan_` | Optional: Please attach a PDF of the student's most up to date IEP or 504 Plan. | contactinformation | 4 | 2025-02-10 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Legacy one-off field (see fill count / Used-in) |  |
| `other_subject` | Other Subject | contactinformation | 0 | 2023-11-29 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Legacy one-off field (see fill count / Used-in) |  |
| `payment_on_file_` | Payment on File? | contactinformation | 270 | 2023-08-17 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Roman 2026-08-10: disregard as pay-type keeper — legacy checkbox |  |
| `pod_pay_per_hour` | SLP Pay Per Hour | new_tutors | 317 | 2022-05-18 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Tutor-recruiting leftover not in the tutor keeper set |  |
| `qualified_lead_enroll_in_workflow` | Qualified Lead, enroll in Workflow | contactinformation | 70 | 2020-08-24 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Legacy one-off field (see fill count / Used-in) |  |
| `quoted_price_per_hour` | Quoted Price Per Hour | contactinformation | 328 | 2019-08-29 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Legacy one-off field (see fill count / Used-in) |  |
| `ready_to_start_date` | Get Started Form Only - Pods | date_properties | 44 | 2021-05-24 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Summer-2021 scheduling flow leftovers |  |
| `reason_for_stopping_last_deal` | Reason for Stopping Last Deal | contactinformation | 0 | 2021-05-21 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Legacy one-off field (see fill count / Used-in) |  |
| `referral___referred_by___email` | Referral - Referred By - Email | referral_program | 54 | 2021-02-11 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Superseded by referral_name keeper |  |
| `referral___referred_by___name` | Referral - Referred by - Name | referral_program | 57 | 2021-02-11 | BLOCKED — referenced by: wf3:$100 - REFERRAL PROGRAM NEW FAMILIES; wf4:$100 - REFERRAL PROGRAM NEW FAMILIES; wf4:REFERRAL PROGRAM NEW FAMILIES | Superseded by referral_name keeper |  |
| `resignation_date_effective` | Resignation Date Effective | new_tutors | 10 | 2022-05-10 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Tutor-recruiting leftover not in the tutor keeper set |  |
| `schedule_preference` | Schedule Preference | customer_group | 2496 | 2021-05-24 | BLOCKED — referenced by: wf3:Copy Properties for Monday; wf3:Get Started Now - FORM SUBMISSION to Deal Create GOLD; wf3:Gold and In person SMS New Deal Created gold and in person; wf4:Charter Traditional SMS New Deal Created … | Free-text schedule pref superseded by per-day fields; classifier key of same name is internal, not this property |  |
...
| `stripe` | Stripe | contactinformation | 2 | 2020-08-17 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Boolean "Stripe" flag from 2020 — payment truth now lives on deals (stripe_*) |  |
| `student_3` | Student 3 | sibling | 4 | 2023-07-12 | HOLD — pending multi-child data-model decision (#AP027) | Sibling stub field — pending multi-child data-model decision | #AP027 |
...
| `tutor_referral___referred_by___email` | Tutor Referral - Referred By - Email | new_tutors | 30 | 2022-04-01 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Tutor-recruiting leftover not in the tutor keeper set |  |
| `tutor_referral___referred_by___name` | Tutor Referral - Referred by - Name | new_tutors | 43 | 2022-04-01 | BLOCKED — referenced by: wf4:REFERRAL PROGRAM - NEW TEACHERS | Tutor-recruiting leftover not in the tutor keeper set |  |
| `tutor_referral_gift_card_sent_` | Tutor Referral Gift Card Sent? | new_tutors | 1 | 2022-04-01 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Tutor-recruiting leftover not in the tutor keeper set |  |
| `tutoring_plan` | Tutoring Plan | unused_properties | 34 | 2022-01-14 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `type_of_enrollment` | Type of Enrollment | conversioninformation | 0 | 2021-05-12 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Legacy enrollment-type field |  |
| `video_ask___pass_first_interview` | Video Ask - Pass First Interview | new_tutors | 794 | 2022-03-07 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Tutor-recruiting leftover not in the tutor keeper set |  |
| `we_ve_waived_cancellation` | Are they aware of our cancellation policy | customer_group | 30 | 2023-07-17 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Legacy ops flag (2021-23 era) |  |
| `what_grade_is_your_child_in` | Student Grade - FB | lead_ads | 9 | 2021-06-23 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Superseded — canonical grade is what_is_your_child_s_current_grade_level_ (Roman 2026-08-10); label "Student Grade - FB" (lead-ad capture) | #AP027 |
| `what_kind_of_tutoring_are_you_looking_for` | What kind of tutoring are you looking for? | unused_properties | 0 | 2022-01-14 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `what_math_is_your_child_currently_working_on_` | What Math is Your Child Currently Working On? | unused_properties | 8 | 2022-01-14 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Group literally named unused_properties — 2021-22 quiz/intake leftovers |  |
| `when_can_we_reach_out_to_you_to_resume_` | When can we reach out to you to resume? Schedule Update | date_properties | 6 | 2021-05-26 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Summer-2021 scheduling flow leftovers |  |
| `when_would_you_like_the_first_lesson` | When would you like the first lesson | contactinformation | 0 | 2023-11-02 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Legacy one-off field (see fill count / Used-in) |  |
| `which_subjects_do_you_feel_you_are_most_experienced_to_tutor_` | Which subjects do you feel you are most experienced to tutor? | new_tutors | 221 | 2021-02-12 | BLOCKED — in use by FORM(s); HubSpot refused delete. Detach/delete the form first. | Tutor-recruiting leftover not in the tutor keeper set |  |
| `why_did_they_not_commit_now_` | Why did they not commit now? | contactinformation | 6 | 2023-08-31 | **ARCHIVED 2026-08-10** (audit clean: 342 workflows, 214 lists, formulas; HubSpot usage-check passed) | Legacy one-off field (see fill count / Used-in) |  |
