...
| Internal name | Label | Why | Decision |
|---|---|---|---|
| `aplus_booth_photo_url` | [Agent] Booth Photo URL | AGENT — public URL of the framed booth photo; email personalization token | PR pending |
