#!/usr/bin/env python3
"""Composite real A+ Tutoring logo onto the v2.3 graphic set for May 19 bundle.
...
GFX = Path("/Users/romanslavinsky/Desktop/aplus-marketing-skills/aplus-content/2026-05-19-weekly/graphics")
